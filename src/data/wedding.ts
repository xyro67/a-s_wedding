export const wedding = {
  couple: {
    groom: 'Dr. Akshay S Suresh',
    bride: 'Dr. Surya Suresh',
    short: 'Akshay & Surya',
  },
  ceremony: {
    day: 'WEDNESDAY',
    date: '2nd DECEMBER 2026',
    displayDate: '2 December 2026',
    malayalamDate: '16th Vrischikam 1202',
    venue: 'Sree Krishna Temple, Guruvayur',
    address: 'East Nada, Guruvayur, Thrissur, Kerala 680101',
    muhurtam: 'After 8:00 AM',
  ...
  families: {
    groom: {
      names: 'Mr. Suresh Kumar M. R. & Mrs. Sreenila Suresh',
